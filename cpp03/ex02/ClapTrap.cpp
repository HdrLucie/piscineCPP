...
ClapTrap::ClapTrap(std::string name) : _lifePoints (10), _energyPoints(10), _attackDG(0)
{
...
void    ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << this->_name << " - life points before heal : " << this->_lifePoints << std::endl;
	this->_lifePoints += amount;
	std::cout << this->_name <<  " - life points after heal : " << this->_lifePoints << std::endl;
	return ;
}
...
void    ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		std::cout << this->_name << " - life points before FIGHT : " << this->_lifePoints << std::endl;
		if (amount >= this->_lifePoints)
		{
			_lifePoints = 0;
			std::cout << this->_name << " - life points : " << this->_lifePoints << "\nYOU LOST THE FIGHT !" << std::endl;
			return ;
		}
		this->_lifePoints -= amount;
		std::cout << this->_name << " - life points after FIGHT : " << this->_lifePoints << std::endl;
	}
	else
